    ...
    foreach ($data as $key => $value) {
        if ($requireds == [] || in_array($key, $requireds)) {
            if (empty($value)) {
                ...
                $errors['valeur_voulu'][1] = "Ce champs ne doit pas être vide";
                $errors['valeur_voulu'][2] = "Ce champs ne doit pas être vide";
                $errors['valeur_voulu'][3] = "Ce champs ne doit pas être vide";
            }
        }
    }
