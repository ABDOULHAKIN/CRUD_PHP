...
<body>
    <div class="sidebar">
        ...
        <ul class="nav list">
            ...
            <!-- 2. Statistiques-->
            <li>
                <a href="/iwatch/statistique.php">
                    <i class='bx bxs-bar-chart-alt-2'></i>
                    <span class="links_user">Les statistiques</span>
                </a>
                <span class="tooltip">Les statistiques</span>
            </li>

            <!-- 2. historique-->
            <li>
                <a href="/iwatch/historique.php">
                <i class='bx bx-history' ></i>
                    <span class="links_user">Historique</span>
                </a>
        ...
        <div class="profile_content">
            <div class="profile">
                <div class="profile_details">
                    <img src="/images/Capture.JPG" alt="" srcset="">
                    <div class="name_job">
